...
class Prediction(object):
    ...
    def _process_video(self,src,dict_,frame_rate=20,threshold=70):
    ...
    def _process_image(self,img,session_id,threshold=60):
        s = self.model(img)
    ...
    def _draw_bounding_box(self,img,result_summary,fontsize=32,outline="#FF999C",width=10,radius=14,threshold=60):
    ...
    def process(self,boundingbox_dict,frame_rate=20,image_dict = None,imagemode = True,threshold=70):
        if not imagemode:
